...
public class Fish {
	 ...
	 */
	public void move() {
		if(direction == Fish.UP) {
			row--;
		}else if (direction == Fish.DOWN) {
			row ++;
		}else if(direction == Fish.LEFT) {
			col--;
		}else if(direction == Fish.RIGHT) {
			col++;
		}else {
	...
	public void setRandomDirection() {
		int x = Random131.getRandomInteger(4);
